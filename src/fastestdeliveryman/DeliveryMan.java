...
public class DeliveryMan extends Employee {
    ...
    public DeliveryMan(String empName, String empID, String empIC, char gender,
     ...
     * Last edited: 25/12/2017 Last edited by: Ng Pei Xiang
     */
    public void clockIn() {
        if (currentRoutine == null) {
            ...
            increaseActive();
            System.out.println("Clocked in successful at " +
                    currentRoutine.getClockInTime() + "\n");
        } else {
    ...
    /**
     * A method to allow delivery man to clock out and record their clock out
     * time Last edited: 25/12/2017 Last edited by: Ng Pei Xiang
     */
    public void clockOut() {
        if (currentRoutine != null) {
            ...
            System.out.println("Clocked out successful at " + 
                    currentRoutine.getClockOutTime() + "\n");
            currentRoutine = null;
        } else {
    ...
    private void startDelivery() {
        if (status == STATUS_AVAILABLE) {
            ...
            System.out.println("You just started a delivery order."
                    + " Please get verification code from the customer "
                    + "when you reached.");
        } else {
    ...
    private void verifyDelivery() {
        ...
        do {
            ...
            if (currentOrder.verifyDelivery(code)) {
                ...
                completeDO++;
                status = STATUS_AVAILABLE;
                System.out.println("\nSuccessful! The delivery order is "
    ...
    /**
     *
     * @return delivery man status in String A method to track delivery man's
     * status Last edited: 25/12/2017 Last edited by: Ng Pei Xiang
     */
    public String getDeliveryManStatus() {
        ...
        switch (status) {
            ...
            case STATUS_DELIVERY:
                deliverymanStatus += "On Delivery";
                break;
            case STATUS_BREAK:
                deliverymanStatus += "On Break";
                break;
            default:
                deliverymanStatus += "Error";
                break;
        }
    ...
    /**
     * A method to display history of delivery job Last edited: 25/12/2017 Last
     * edited by: Ng Pei Xiang
     */
    ...
    public void displayRoutineHistory() {
        ...
        System.out.printf("%-20s %-20s %-20s %-20s\n", "Date", "Clock In Time",
                "Clock Out Time", "Total Working Hour");
