...
public abstract class Employee {
    ...
    public static Employee loginAccount(ADTLinkedListInterface<Employee> employeeList) {
        ...
        if (userID.equals("") || userPassword.equals("")) {
            ...
            while (!found && employeeList.getEntry(count) != null) {
                if (userID.equals(employeeList.getEntry(count).empID) && userPassword.equals(employeeList.getEntry(count).password)) {
    ...
    public String toString() {
        return empID + "  " + empName + "   " + empIC +"   "+gender+"      "+salary+"     "+contactNo+"   "+address+"\n";
    }
}
